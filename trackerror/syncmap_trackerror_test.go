...
func TestNewSyncMapTrackError(t *testing.T) {
	tracker := NewSyncMapTrackError()
	if tracker == nil {
		t.Fatal("NewSyncMapTrackError() returned nil")
	}
	
	if tracker.Count() != 0 {
		t.Errorf("NewSyncMapTrackError() count = %d, want 0", tracker.Count())
	}
}

func TestSyncMapTrackError_Store(t *testing.T) {
	tracker := NewSyncMapTrackError()
...
func TestSyncMapTrackError_Load(t *testing.T) {
	tracker := NewSyncMapTrackError()
...
func TestSyncMapTrackError_Delete(t *testing.T) {
	tracker := NewSyncMapTrackError()
...
func TestSyncMapTrackError_Count(t *testing.T) {
	tracker := NewSyncMapTrackError()
...
func TestSyncMapTrackError_ConcurrentAccess(t *testing.T) {
	tracker := NewSyncMapTrackError()
...
func TestSyncMapTrackError_ConcurrentStoreLoad(t *testing.T) {
	tracker := NewSyncMapTrackError()
	var wg sync.WaitGroup
...
func TestSyncMapTrackError_ConcurrentStoreDelete(t *testing.T) {
	tracker := NewSyncMapTrackError()
	var wg sync.WaitGroup
...
func TestSyncMapTrackError_Interface(t *testing.T) {
	var _ TrackError = NewSyncMapTrackError()
}

func TestSyncMapTrackError_EmptyKey(t *testing.T) {
	tracker := NewSyncMapTrackError()
...
func TestSyncMapTrackError_MultipleOperations(t *testing.T) {
	tracker := NewSyncMapTrackError()
